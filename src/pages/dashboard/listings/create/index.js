    ...
    return (
        <Layout>
            <div className="px-8 py-8">
                <h1 className="text-xl font-semibold w-full border-b border-gray-200 pb-4">Create a new listing</h1>

                <div className="mx-auto">
                    <Formik
                        initialValues={{ property_name: "", property_id: "", visibility: "0", property_category:"", property_type: "", address: "", sublocality: "", state: "", latitude:"",longitude: "", beds:"", bath:"", area:"", feature_image: "" }}
