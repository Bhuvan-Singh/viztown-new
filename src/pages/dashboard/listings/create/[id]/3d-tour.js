...
export default function ActualSiteData(props) {
    ...
    useEffect(() => {
        ...
        axiosConfig
            .get("/propertyActualSiteDataClient", {
                params: {
                    ...
                    {initialValues === null ? (
                        ...
                        <Formik
                            ...
                            onSubmit={(values, { setSubmitting }) => {
                                ...
                                axiosConfig
                                    .post("/addActualSiteData", formData, {
                                        config: {
                                            headers: {
                                                "Content-Type":
                                                    "multipart/form-data",
                                    ...
                                    >
                                        ...
                                        {asType == 2 ? (
                                            ...
                                            <div>
                                                                            ...
                                                                            <div className="flex-col space-y-2 items-start p-4">
                                                                                ...
                                                                                <div className="flex flex-col space-y-2">
                                                                                    ...
                                                                                    <Field
                                                                                        ...
                                                                                        className={`outline-none border border-gray-300 p-4 h-11 bg-white text-xs font-semibold rounded-md ${
                                                                                            photoErrors.sort_order &&
                                                                                            photoTouched.sort_order &&
                                                                                            "error"
                                                                                        }`}
                                                                                    />
                                                                                    {photoErrors.sort_order &&
                                                                                ...
                                                                                <div className="flex space-y-2">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        className={`mt-4 py-3 uppercase border-box h-11 text-sm px-4 bg-red-500 text-white font-bold hover:opacity-80 hover:text-white transition duration-200 ease-in-out  rounded-md inline-block cursor-pointer flex space-x-1 items-center`}
                                                                                        onClick={(
                                                                                            e
                                                                                        ) =>
                                                                                            handleRemoveClick(
                                                ...
                                                <div
                                                    className={`mt-4 py-3 uppercase border-box h-11 text-sm px-6 bg-green-300 text-white font-bold hover:opacity-80 hover:text-white transition duration-200 ease-in-out  rounded-full inline-block`}
                                                    onClick={(e) =>
                                                        handleAddClick(
                                                            e,
                                                            values,
                                        ...
                                        <div className="mt-8 flex item-center space-x-4">
                                            ...
                                            <Link
                                                to={`/dashboard/listings/create/${values.id}/info-map`}
