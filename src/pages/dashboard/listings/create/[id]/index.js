        ...
        axiosConfig
            ...
            .then(function (response) {
                ...
                existingData === null
                    ...
                    : setInitialValues({
                          id: props.id,
                          property_name: existingData.name,
                          property_id: existingData.propertyId,
                          visibility: existingData.visibility,
                          property_category: existingData.category,
                          property_type: existingData.type,
                          address: existingData.location,
                          property_location: existingData.property_location,
                          latitude: existingData.latitude,
                          longitude: existingData.longitude,
                          beds: existingData.beds,
                          bath: existingData.baths,
                          area: existingData.carpetArea,
                          feature_image: existingData.featuredImage,
                      });
            })
