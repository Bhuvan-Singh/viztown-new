                        ...
                        <form className="relative" onSubmit={handleSubmit}>
                            <div className={`flex flex-col gap-4 py-16 mt-8 ${isSubmitting ? 'opacity-20' : ''}`}>
                                <div className="w-full text-center mb-4">
                                    <h4 className="text-3xl font-bold font-playfair text-primary">Sign In</h4>
                                </div>
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    <label className="text-sm font-semibold text-primary" htmlFor="email">Password</label>
                                    <input
                                        name="password"
                                        type="password"
                                        ...
                                        onChange={handleChange}
                                        onBlur={handleBlur}
                                        className={`outline-none border border-gray-200 p-4 h-11 bg-grey text-xs font-semibold ${errors.password && touched.password && "error"}`}
                                    />
                                    {errors.password && touched.password && (
                                        <div className="input-feedback text-red-400 text-xs font-semibold capitalize">{errors.password}</div>
                                    )}
                                </div>
                                <div className="w-full text-center mt-3">
                                    <button type="submit" disabled={isSubmitting} className={ `uppercase w-full border-box h-11 text-sm px-10 bg-secondary text-white font-bold hover:opacity-80 hover:text-white transition duration-200 ease-in-out ${isSubmitting? 'opacity-20' : ''}`}>
                                        Login
                                    </button>
                                </div>
