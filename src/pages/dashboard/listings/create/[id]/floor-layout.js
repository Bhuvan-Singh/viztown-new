		...
		axiosConfig
			...
			.then(function (response) {
				...
				if (response.data.data) {
					...
					document.getElementById(`layout-${id}`).remove();
				} else {
				...
				<div className="mx-auto">
					<Formik
						...
						onSubmit={(values, { setSubmitting, resetForm }) => {
							...
							axiosConfig
								.post("/addPropertyFloorLayout", formData, {
									config: {
										headers: {
											"Content-Type":
												"multipart/form-data",
