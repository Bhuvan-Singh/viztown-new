...
export default function ListingTileViewHorizontal({ property }) {
	return (
		<a
			className="vt-listing rounded-md border border-gray-200 bg-white relative flex-col items-center rounded-xl relative "
			href={`/showcase/${property.slug}`}
			target="_blank"
		>
			<div className="rounded-xl w-full overflow-hidden p-2">
				<FeaturedImg
			...
			<div className="vt-listing-details px-6 2xl:px-6 flex-grow">
