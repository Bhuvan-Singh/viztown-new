            ...
            .then(function (response) {
                ...
                infoMapData === null
                    ...
                    : setInitialValues({
                          ...
                          property_type: infoMapData.buildDetails.propertyType,
                                    ...
                                    >
                                        ...
                                        <div className="mt-5 flex item-center space-x-4">
                                            <button
                                                ...
                                                className={`uppercase border-box h-11 text-sm px-10 bg-secondary text-white font-bold hover:opacity-80 hover:text-white transition duration-200 ease-in-out rounded-full ${
                                                    isSubmitting
                                                        ? "opacity-20"
                                                        : ""
                                                }`}
