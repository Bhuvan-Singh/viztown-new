...
export default function index() {
    ...
    return (
        <Layout>
            <div className="vt-dashboard-overview flex items-center py-6 2xl:py-6 px-10 border-b border-gray-100">
                <MeetingsView/>
            ...
            <div className="vt-dashboard-overview grid grid-cols-3 gap-4 px-10 py-8">
                <Properties propertyListings={propertyListings}/>
                <Meetings/>
                <Proposals/>
            </div>
            <div className="vt-dashboard-hot-properties px-10">
                ...
                <ListingsTileView propertyListings={propertyListings}/>
            </div>
        </Layout>
    )
}
