                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-1 mt-6 gap-6 gap-x-12">
                                            <div className="w-full flex flex-col gap-2">
                                                ...
                                                <textarea
                                                    ...
                                                    onChange={handleChange}
                                                    onBlur={handleBlur}
                                                    className={`outline-none border border-gray-300 p-4 h-24 bg-white text-xs font-semibold rounded-md ${
                                                        errors.agenda &&
                                                        touched.agenda &&
                                                        "error"
                                                    }`}
                                        ...
                                        <div className="mt-5">
                                            <button
                                                ...
                                                className={`uppercase border-box h-11 text-sm px-10 bg-dashboardBlue text-white font-bold hover:opacity-80 hover:text-white transition duration-200 ease-in-out rounded-full ${
                                                    isSubmitting
                                                        ? "opacity-20"
                                                        : ""
                                                }`}
