...
export default function NavigationFI({slug}) {
    return (
        <div className={`relative w-full bg-white absolute top-0 py-2 z-10 md:flex items-center mx-auto capitalize justify-center gap-2 whitespace-nowrap lg:whitespace-normal overflow-y-hidden overflow-x-auto`}>
            <Link 
