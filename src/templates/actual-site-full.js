...
export default function ActualSiteFull({pageContext}) {
    ...
    return (
        <LayoutNoFooter>
            ...
            <div className="vt-showcase mx-auto relative z-10" >
                <Link to={`/showcase/${pageContext.slug}/actual-site`} className="absolute left-0 bg-gray-200 pl-1 pr-2 py-1 top-1 rounded-r-xl z-50">
