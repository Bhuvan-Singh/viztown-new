                                ...
                                >
                                    ...
                                    <div className="w-full text-center mt-3">
                                        <button
                                            ...
                                            className={`uppercase w-full border-box h-11 text-sm px-10 bg-secondary text-white font-bold hover:bg-primary hover:text-white transition duration-200 ease-in-out ${
                                                isSubmitting ? "opacity-20" : ""
                                            }`}
                                        >
